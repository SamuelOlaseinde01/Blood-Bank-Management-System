...
import { bloodDonate, donorGetCreds } from "../Form-components/Donor-forms/donorApi";
...
export async function loader() {
    try {
        ...
        const userData = await donorGetCreds(username)
        return userData
    } catch (err) {
                ...
                <div className="blood-donate">
                    ...
                    <Form method="post" className="blood-donate-form">
                        ...
                        <div className="blood-donate-label-form">
                            ...
                            <button className={navigation.state === "submitting" ? "signup-submitting-btn" : "signup-submit-btn"} disabled={navigation.state === "submitting"}>{navigation.state === "submitting" ? "Donating.." : "Donate"}</button>
                    </Form>
                </div>
            </div>
        </>
