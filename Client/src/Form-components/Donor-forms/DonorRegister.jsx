...
import { donorPostRegister } from "./donorApi";
...
export async function action({request}) {
    ...
    try{
        await donorPostRegister(data)
        return redirect("/donor-login?message=Successfully signed up, you can now proceed to Log in")   
    } catch (err) {
        ...
        <div className="register-container">
            ...
            <Form method="post" className="register-form">
                ...
                <div className="no-account">
                    <p>Already have an account? <Link style={{textDecoration: "none", color: "red"}} to={"/donor-login"}>Log in</Link></p>
                </div>
            </Form>
        </div>
        </div>
