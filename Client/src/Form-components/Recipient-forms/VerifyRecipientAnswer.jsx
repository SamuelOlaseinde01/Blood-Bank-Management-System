...
import { verifyRecipientsAnswer } from "./recipientApi";
...
export async function action({request}) {
    try {
        ...
        const username = await verifyRecipientsAnswer(data)
        const urlUsername = data.username
        return redirect(`/change-recipient-password?username=${urlUsername}`)
    } catch(err) {
...
export default function VerifyRecipientAnswer() {
